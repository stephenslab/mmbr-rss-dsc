...
for(case in 1:nrow(all.comb)){
  ...
  output_glob = paste0('ukb_rss_20210313_pip_extraction/ukb_rss_pip_simu', simu,'_glob.rds')
  output_cond = paste0('ukb_rss_20210313_pip_extraction/ukb_rss_pip_simu', simu,'_cond.rds')

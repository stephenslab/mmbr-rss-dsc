...
for(case in 1:nrow(all.comb)){
  ...
  input = paste0('ukb_rss_20210107_pip_extraction/ukb_rss_pip_simu', simu,'.rds')
  output = paste0('ukb_rss_20210107_pip_calibration/ukb_rss_pip_cali_simu', simu)
  ...
  files = paste0(output, '_', seq(1:idx), '.png')
